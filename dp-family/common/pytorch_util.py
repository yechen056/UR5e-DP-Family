...
def replace_submodules(
    ...
    """
    Replace matching submodules in-place and return the updated module tree.
    """
    ...
    for *parent, key in submodule_paths:
    ...
    remaining = [
        name for name, module in root_module.named_modules(remove_duplicate=True)
        if predicate(module)
    ]
