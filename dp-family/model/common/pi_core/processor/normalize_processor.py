...
from model.common.pi_core.configs.types import FeatureType, NormalizationMode, PipelineFeatureType, PolicyFeature
from model.common.pi_core.types import EnvTransition, PolicyAction, TransitionKey
from model.common.pi_core.utils.constants import ACTION

from .converters import from_tensor_to_numpy, to_tensor
from .pipeline import PolicyProcessorPipeline, ProcessorStep, ProcessorStepRegistry, RobotObservation


class _DatasetMetaWithStats(Protocol):
    stats: dict[str, dict[str, Any]]


class _DatasetWithStats(Protocol):
    @property
    def meta(self) -> _DatasetMetaWithStats: ...
...
class _NormalizationMixin:
    ...
    **Stats Override Preservation:**
    ...
    Examples:
        ```python
        # Common use case: Override with dataset stats from your dataset wrapper
        dataset = my_dataset
